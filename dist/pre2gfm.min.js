...
"use strict";function _slicedToArray(e,r){return _arrayWithHoles(e)||_iterableToArrayLimit(e,r)||_unsupportedIterableToArray(e,r)||_nonIterableRest()}function _iterableToArrayLimit(e,r){var t=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=t){var n,a,o,i,l=[],u=!0,s=!1;try{if(o=(t=t.call(e)).next,0===r){if(Object(t)!==t)return;u=!1}else for(;!(u=(n=o.call(t)).done)&&(l.push(n.value),l.length!==r);u=!0);}catch(e){s=!0,a=e}finally{try{if(!u&&null!=t.return&&(i=t.return(),Object(i)!==i))return}finally{if(s)throw a}}return l}}function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _toArray(e){return _arrayWithHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,r){if(e){if("string"==typeof e)return _arrayLikeToArray(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(e):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?_arrayLikeToArray(e,r):void 0}}function _arrayLikeToArray(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}function _iterableToArray(e){if("undefined"!=typeof Symbol&&null!=e[Symbol.iterator]||null!=e["@@iterator"])return Array.from(e)}function _arrayWithHoles(e){if(Array.isArray(e))return e}var mdRender=require("marked").parse,getOwn=require("getown"),_window=window,hljs=_window.hljs,sani=!1;function dotText(e){return e.text()}function pre2gfm(){pre2gfm.scan()}function urlNoHash(e){return String(e).split(/#/)[0]}var bodyCacheBust=document.body.getAttribute("markdown-from-file-cachebust"),docUrlNoHash=urlNoHash(window.document.URL),now=Date.now;function orf(e){return e||!1}function inStr(e,r){return r.indexOf(e)>=0}function hasCls(e,r){return e&&inStr(r," "+e.className+" ")}function eachElemCls(e,r,t){var n,a,o=document.getElementsByTagName(e),i=o.length;if(i)for(o=[].slice.call(o),n=0;n<i;n+=1)hasCls(a=o[n],r)&&t(a)}now||(now=function(){return(new Date).getTime()});var mdOpt={gfm:!0,breaks:!1,headerPrefix:"hl-",langPrefix:"hljs ",mangle:!1,sanitize:Boolean(sani)};function rescrollToHeadline(){var e=window.location.hash,r="#"+mdOpt.headerPrefix;e.startsWith(r)&&(window.location.hash=e)}function runEventHandlerChain(e,r){var t=_toArray(e),n=t[0],a=t.slice(1);a.length&&setTimeout(runEventHandlerChain.bind(null,a,r),10),n&&n.apply(void 0,_toConsumableArray(r))}function triggerOnRendered(e){runEventHandlerChain([rescrollToHeadline].concat(pre2gfm.onRendered),[e])}function transformOneTagText(e){var r=e.parentNode,t=document.createElement("div");return t.className=e.className,t.classList.add("markdown"),t.innerHTML=mdRender(e.innerHTML),r&&(r.insertBefore(t,e),setTimeout(function(){r.removeChild(e)},1)),triggerOnRendered(t),t}mdOpt.httpGet=orf(window.axios).get||window.fetch.bind(window),sani&&(mdOpt.sanitizer=sani),pre2gfm.hljsProxy=function(e,r){return hljs.highlight(e,{language:r,ignoreIllegals:!0}).value},pre2gfm.plainTextProxy=function(e){return pre2gfm.hljsProxy(e,"text")},pre2gfm.syntaxHighlighters={"*":pre2gfm.hljsProxy,"":pre2gfm.plainTextProxy},mdOpt.highlight=function(e,r,t){var n,a=pre2gfm.syntaxHighlighters;a=getOwn(a,r)||getOwn(a,"*");var o="";try{o=a(e,r)}catch(e){n=e}return n&&console.warn("pre2gfm: Failed to highlight code:",String(n),{err:n,lang:r,code:o,origCode:e}),t?t(null,o):o},mdRender.setOptions(mdOpt),pre2gfm.runEventHandlerChain=runEventHandlerChain,pre2gfm.onRendered=[];var cacheBusterValueGenerators={rand:function(){return Math.random().toString(26).slice(2)},uts:function(){return Math.floor(now()/1e3)}};function maybeBustCache(e,r){var t=r||bodyCacheBust;if(!t)return e;var n=_slicedToArray(String(t||"").split(/^([a-z]+) ?/),3),a=n[1],o=n[2],i=getOwn(cacheBusterValueGenerators,a||"");return i?e+o+i():(console.warn("pre2gfm: Unknown cache buster value generator:",a),e)}function fetchOneTagText(e){var r=e.getAttribute("href");if(r){var t=transformOneTagText(e),n=e.getAttribute("codelang");if(r.startsWith("#"))return a(orf(document.getElementById(r.slice(1))).innerHTML||r);(r=urlNoHash(e.href))!==docUrlNoHash&&(r.startsWith("about:")||(r=maybeBustCache(r,e.getAttribute("cachebust")),mdOpt.httpGet(r).then(dotText).then(String,String).then(a).catch(function(e){console.error("pre2gfm fetch error:",[r,e])})))}function a(e){var r=e.replace(/\r|\uFEFF/g,"");"\n"!==r.slice(-1)&&(r+="\n"),n&&(r="```"+n+"\n"+r+"```\n"),t.innerHTML=mdRender(r),t.classList.remove("hourglass"),triggerOnRendered(t)}}pre2gfm.scan=function(){eachElemCls("pre"," markdown ",transformOneTagText),eachElemCls("a"," markdown-from-file ",fetchOneTagText)},pre2gfm.formURL=function(e,r){return fetchOneTagText({href:e,getAttribute:function(e){return String(orf(r)[e]||"")}})},window.pre2gfm=pre2gfm,module.exports=pre2gfm,setTimeout(pre2gfm,1);
