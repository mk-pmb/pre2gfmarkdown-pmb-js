...
return Pe}()
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";var hop=Object.prototype.hasOwnProperty;function getown(t,o,e){return t&&hop.call(t,o)?t[o]:e}getown.voc=function(t,o){return getown(t,o,o)},module.exports=getown;
...
"use strict";function _slicedToArray(r,e){return _arrayWithHoles(r)||_iterableToArrayLimit(r,e)||_unsupportedIterableToArray(r,e)||_nonIterableRest()}function _iterableToArrayLimit(r,e){var t=null==r?null:"undefined"!=typeof Symbol&&r[Symbol.iterator]||r["@@iterator"];if(null!=t){var n,a,o,i,l=[],u=!0,s=!1;try{if(o=(t=t.call(r)).next,0===e){if(Object(t)!==t)return;u=!1}else for(;!(u=(n=o.call(t)).done)&&(l.push(n.value),l.length!==e);u=!0);}catch(r){s=!0,a=r}finally{try{if(!u&&null!=t.return&&(i=t.return(),Object(i)!==i))return}finally{if(s)throw a}}return l}}function _toConsumableArray(r){return _arrayWithoutHoles(r)||_iterableToArray(r)||_unsupportedIterableToArray(r)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _arrayWithoutHoles(r){if(Array.isArray(r))return _arrayLikeToArray(r)}function _toArray(r){return _arrayWithHoles(r)||_iterableToArray(r)||_unsupportedIterableToArray(r)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(r,e){if(r){if("string"==typeof r)return _arrayLikeToArray(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);return"Object"===t&&r.constructor&&(t=r.constructor.name),"Map"===t||"Set"===t?Array.from(r):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?_arrayLikeToArray(r,e):void 0}}function _arrayLikeToArray(r,e){(null==e||e>r.length)&&(e=r.length);for(var t=0,n=new Array(e);t<e;t++)n[t]=r[t];return n}function _iterableToArray(r){if("undefined"!=typeof Symbol&&null!=r[Symbol.iterator]||null!=r["@@iterator"])return Array.from(r)}function _arrayWithHoles(r){if(Array.isArray(r))return r}var mdRender=require("marked").parse,getOwn=require("getown"),_window=window,hljs=_window.hljs,sani=!1;function dotText(r){return r.text()}function pre2gfm(){pre2gfm.scan()}function urlNoHash(r){return String(r).split(/#/)[0]}var bodyCacheBust=document.body.getAttribute("markdown-from-file-cachebust"),docUrlNoHash=urlNoHash(window.document.URL),now=Date.now;function orf(r){return r||!1}function inStr(r,e){return e.indexOf(r)>=0}function hasCls(r,e){return r&&inStr(e," "+r.className+" ")}function eachElemCls(r,e,t){var n,a,o=document.getElementsByTagName(r),i=o.length;if(i)for(o=[].slice.call(o),n=0;n<i;n+=1)hasCls(a=o[n],e)&&t(a)}now||(now=function(){return(new Date).getTime()});var mdOpt={gfm:!0,breaks:!1,headerPrefix:"hl-",langPrefix:"hljs ",mangle:!1,sanitize:Boolean(sani)};function rescrollToHeadline(){var r=window.location.hash,e="#"+mdOpt.headerPrefix;r.startsWith(e)&&(window.location.hash=r)}function runEventHandlerChain(r,e){var t=_toArray(r),n=t[0],a=t.slice(1);a.length&&setTimeout(runEventHandlerChain.bind(null,a,e),10),n&&n.apply(void 0,_toConsumableArray(e))}function triggerOnRendered(r){runEventHandlerChain([rescrollToHeadline].concat(pre2gfm.onRendered),[r])}function transformOneTagText(r){var e=r.parentNode,t=document.createElement("div");return t.className=r.className,t.classList.add("markdown"),t.innerHTML=mdRender(r.innerHTML),e&&(e.insertBefore(t,r),setTimeout(function(){e.removeChild(r)},1)),triggerOnRendered(t),t}mdOpt.httpGet=orf(window.axios).get||window.fetch.bind(window),sani&&(mdOpt.sanitizer=sani),function(){function r(r,e){var t={language:e||"text",ignoreIllegals:!0};return hljs.highlight(r,t).value}pre2gfm.hljsProxy=r;var e=new Map;r.forLang=function(t){var n=e.get(t);if(n)return n;var a=function(e){return r(e,t)};return e.set(t,a),a}}(),pre2gfm.syntaxHighlighters={"*":pre2gfm.hljsProxy,"":pre2gfm.hljsProxy.forLang("text"),powershell:pre2gfm.hljsProxy.forLang("csharp"),pwsh:pre2gfm.hljsProxy.forLang("csharp")},mdOpt.highlight=function(r,e,t){var n,a=pre2gfm.syntaxHighlighters;a=getOwn(a,e)||getOwn(a,"*");var o="";try{o=a(r,e)}catch(r){n=r}if(n){var i=(String(n.message||"").split("Unknown language: ")[1]||"").replace(/"/g,"").trim(),l={err:n,lang:e,unkLang:i,code:o,origCode:r};if(i&&delete l.origCode,console.warn("pre2gfm: Failed to highlight code:",String(n),l),i)try{o=a(r,"text")}catch(r){console.warn("pre2gfm: Failed to fallback-render code as plain text:",String(r))}}return t?t(null,o):o},mdRender.setOptions(mdOpt),pre2gfm.runEventHandlerChain=runEventHandlerChain,pre2gfm.onRendered=[];var cacheBusterValueGenerators={rand:function(){return Math.random().toString(26).slice(2)},uts:function(){return Math.floor(now()/1e3)}};function maybeBustCache(r,e){var t=e||bodyCacheBust;if(!t)return r;var n=_slicedToArray(String(t||"").split(/^([a-z]+) ?/),3),a=n[1],o=n[2],i=getOwn(cacheBusterValueGenerators,a||"");return i?r+o+i():(console.warn("pre2gfm: Unknown cache buster value generator:",a),r)}function fetchOneTagText(r){var e=r.getAttribute("href");if(e){var t=transformOneTagText(r),n=r.getAttribute("codelang");if(e.startsWith("#"))return a(orf(document.getElementById(e.slice(1))).innerHTML||e);(e=urlNoHash(r.href))!==docUrlNoHash&&(e.startsWith("about:")||(e=maybeBustCache(e,r.getAttribute("cachebust")),mdOpt.httpGet(e).then(dotText).then(String,String).then(a).catch(function(r){console.error("pre2gfm fetch error:",[e,r])})))}function a(r){var e=r.replace(/\r|\uFEFF/g,"");"\n"!==e.slice(-1)&&(e+="\n"),n&&(e="```"+n+"\n"+e+"```\n"),t.innerHTML=mdRender(e),t.classList.remove("hourglass"),triggerOnRendered(t)}}pre2gfm.scan=function(){eachElemCls("pre"," markdown ",transformOneTagText),eachElemCls("a"," markdown-from-file ",fetchOneTagText)},pre2gfm.formURL=function(r,e){return fetchOneTagText({href:r,getAttribute:function(r){return String(orf(e)[r]||"")}})},window.pre2gfm=pre2gfm,module.exports=pre2gfm,setTimeout(pre2gfm,1);
